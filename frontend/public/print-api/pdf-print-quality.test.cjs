...
assert.match(app, /printBackgroundGraphics/, 'print rendering reads the PDF/background checkbox');
assert.match(app, /enterPrintPreviewMode/, 'top-level print opens the print preview panel before printing');
